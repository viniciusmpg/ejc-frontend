...
function DeleteButton(props) {
    ...
    function confirmDelete() {
        client.delete(`persons/${props.personId}`).then(function (response) {
    ...
    return (
        <React.Fragment>
            <Fab size="small" color="secondary" aria-label="delete" onClick={handleClickOpen} className={props.className}>
                <DeleteIcon />
            </Fab>
            <Dialog
                open={open}
